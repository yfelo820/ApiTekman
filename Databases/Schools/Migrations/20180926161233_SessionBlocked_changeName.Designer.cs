...
namespace Api.Databases.Schools.Migrations
{
    ...
    [Migration("20180926161233_SessionBlocked_changeName")]
    partial class SessionBlocked_changeName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Entities.Schools.SessionBlocked", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("GroupId", "LanguageKey", "SubjectKey", "Course", "Session")
                        .IsUnique()
                        .HasName("Index_SessionBlocked_UniqueSessionBlocked")
                        .HasFilter("[LanguageKey] IS NOT NULL AND [SubjectKey] IS NOT NULL");

                    b.ToTable("SessionBlocked");
                });
